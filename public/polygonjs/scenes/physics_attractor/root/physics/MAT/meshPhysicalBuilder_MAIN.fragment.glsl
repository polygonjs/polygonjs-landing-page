...
void main() {
	...
	// /physics/MAT/meshPhysicalBuilder_MAIN/constant1
	vec3 v_POLY_constant1_val = vec3(0.8862745098039215, 0.19607843137254902, 0.596078431372549);
	
	// /physics/MAT/meshPhysicalBuilder_MAIN/output1
