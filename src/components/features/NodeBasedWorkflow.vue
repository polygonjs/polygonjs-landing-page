...
<template>
	<section>
		...
		<p>
			...
			<span class="bg-emerald-300 dark:bg-emerald-800">3D scenes by connecting nodes together.</span> Some nodes
		...
		<p>
			...
			step. <span class="bg-sky-300 dark:bg-sky-800">And you get better at your craft, fast</span>.
		</p>
	</section>
</template>
