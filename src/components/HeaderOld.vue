		...
		<nav class="mx-auto max-w-7xl px-6 lg:px-8" aria-label="Top">
			...
			>
				...
				<div class="ml-10 space-x-4">
					<a
						href="#"
						class="inline-block rounded-xs border border-transparent bg-sky-800 py-2 px-4 text-base font-medium text-white hover:bg-opacity-75"
						>Sign in</a
					>
					<a
						href="#"
						class="inline-block border border-transparent py-2 px-4 text-base font-medium text-white hover:bg-opacity-75"
						>Sign up</a
					>
				</div>
			</div>
