...
import { PolySceneWithNodeMap_physics_grow } from "./PolySceneWithNodeMap";
...
interface LoadedData {
  scene: PolySceneWithNodeMap_physics_grow;
...
declare const loadSceneFromSceneData_physics_grow: LoadSceneMethod;
