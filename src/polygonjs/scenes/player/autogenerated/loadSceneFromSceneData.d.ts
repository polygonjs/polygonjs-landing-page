...
import { PolySceneWithNodeMap_player } from "./PolySceneWithNodeMap";
...
interface LoadedData {
  scene: PolySceneWithNodeMap_player;
...
declare const loadSceneFromSceneData_player: LoadSceneMethod;
